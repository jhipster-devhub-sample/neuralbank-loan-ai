...
KEYCLOAK_POST_LOGOUT_URI="${VITE_KEYCLOAK_POST_LOGOUT_REDIRECT_URI:-}"
...
KEYCLOAK_POST_LOGOUT_URI_ESC=$(escape_js "$KEYCLOAK_POST_LOGOUT_URI")
...
window.__ENV__ = {
  ...
  VITE_KEYCLOAK_POST_LOGOUT_REDIRECT_URI: '$KEYCLOAK_POST_LOGOUT_URI_ESC',
